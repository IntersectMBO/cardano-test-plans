...
## 2D: Delegation options on the dRep Delegation Page
...
## 2K: Delegation page should be accessible on disconnected state

**User Story:** As a user without a compatible wallet connected to GovTool, I want the delegation page to be accessible.
